...
def baseline_model(params):
    ...
    if not params.train_only:
        ...
        negative_fix = params.negative_fix if params.negative_fix in ["VALUE_SHIFT", "ABS_REC_ACTV"] else None
...
def input_cluster_model(params):
    BATCH_SIZE = params.batch_size
    EPOCHS = params.epochs
    CLUSTERS_PER_CLASS = params.num_clusters_per_class
    ...
    if not params.train_only:
        ...
        for alpha in params.alphas:
            ...
            save_oscr_values(params.eperiment_data_dir,"base", 1, ccr_fpr_per_model, alpha, params.negative_fix)
